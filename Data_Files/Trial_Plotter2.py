...
rp1_path = os.path.join('raspberrypi1', 'raspberrypi1_235')
rp2_path = os.path.join('raspberrypi2', 'raspberrypi2_235')
rp3_path = os.path.join('raspberrypi3', 'raspberrypi3_235')
