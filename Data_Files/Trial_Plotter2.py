...
rp1_path = os.path.join('raspberrypi1', 'raspberrypi1_1214')
rp2_path = os.path.join('raspberrypi2', 'raspberrypi2_1214')
rp3_path = os.path.join('raspberrypi3', 'raspberrypi3_1214')
